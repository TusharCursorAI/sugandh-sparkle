      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-0 right-0 sm:bottom-6 sm:right-6 z-50 w-full sm:w-96 max-h-[100dvh] sm:max-h-[80vh] sm:rounded-lg overflow-hidden shadow-elevated bg-card border border-border flex flex-col"
          >
            {/* Header */}
